...
#define STRING_CONFIG_H_AUTHOR "(MMM, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3+ BL 4.2.7"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  24.48 }
    #define DEFAULT_Ki_LIST {   2.02 }
    #define DEFAULT_Kd_LIST {  74.07}
  #else
    #define DEFAULT_Kp  24.48
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42.3, -4.6, -3.20 }
