...
#define STRING_CONFIG_H_AUTHOR "(myronmcm, Ender-3 Sprite Pro+ 2.85)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Sprite 2.85"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -37, -39, 0 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
